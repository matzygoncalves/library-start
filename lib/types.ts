...
interface Effects {
  shadow: ShadowEffect;
  border: {
    subtle: { 1: BorderEffect };
    strong: { 1: BorderEffect };
    focus: BorderEffect;
...
export interface ThemeTypes {
  colors: {
    ...
    text: Palette;
    link: Palette;
    support: Palette & { caution: Palette };
    button: Palette & { danger: Palette; separetor: Color };
    layerAccent: Palette;
    field: Palette;
    focus: Palette;
    miscellaneous: Palette & {
      skeleton: { background: Color; element: Color };
    };
  };
  effects: Effects;
