  ...
  colors: {
    ...
    layer: {
      ...
      selected: {
        ...
        selectedHover: {
          1: palette.hover.gray[70],
          2: palette.hover.gray[60],
    ...
    button: {
      ...
      danger: {
        ...
        secondary: {
          default: palette.default.red[40],
          hover: palette.hover.red[60],
          active: palette.default.red[80],
        },
      },
      separetor: palette.default.gray[100],
      disabled: palette.default.gray[60],
    },
    ...
    layerAccent: {
      ...
      3: {
        default: palette.default.gray[50],
        hover: palette.hover.gray[50],
